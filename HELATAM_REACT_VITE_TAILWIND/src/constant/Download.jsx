...
export const Download = () => {
    return (
        <div className="w-full bg-[#e0bf64] h-44 rounded-t-3xl">
            {/* CORREGIR w-full por w-screen arriba */}
            <div className="relative w-full h-full flex flex-col md:flex-row justify-center items-center gap-6 lg:gap-10">
                <div className="">
