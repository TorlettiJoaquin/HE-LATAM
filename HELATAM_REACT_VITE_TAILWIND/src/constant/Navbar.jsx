...
import heico from "../../public/he.ico";
...
export const Navbar = () => {
    ...
    return (
        <div className="sticky top-0 grid grid-cols-[200px_1fr] gap-6 items-center bg-gradient-to-b from-blue-900 to-blue-950 shadow-[0_0_10px_0_rgba(0,0,0,.3)] z-20">
            <div className="relative">
                <Link
                    to="/"
                    className="block relative transform-none left-0 top-0 p-[5px_0_0_24px] max-w-none xl:pt-2 "
                >
                    <img
                        src={hemlogo2}
                        alt="HEM MAWEL LOGO"
                        className="w-[200px] -mb-8 max-w-full"
                    />
                </Link> 
            </div>
            <nav className="lg:block lg:static lg:h-auto lg:visible w-full">
                <div className="grid grid-cols-[1fr_max-content] gap-2 h-auto max-w-none w-full justify-between pr-4">
                    <ul className="flex items-center font-semibold [&>*]:mr-2 [&>*]:uppercase [&>*]:[&>*]:px-4 [&>*]:[&>*]:py-[7px] [&>*]:[&>*]: [&>*]:[&>*]:relative">
                        <Link to="/" className="">
                            <li className="active hover:active">
                                Inicio
                                <img src={heico} alt="" className="block absolute h-[16px] w-[16px] -bottom-2 left-[calc(50%_-_(16px/2))]" />
                            </li>
                        </Link>
                        <Link
                            to="/guide/gameinfo"
